...
def bear_room():
    ...
    print("The fat bear is in the front another door.")
    ...
    while True:
        ...
        if choice == "take honey":
            dead("The bear looks at you then spas your face off.")
        elif choice == "taunt bear" and not bear_moved:
            print("The bear has moved from the door.")
            print("You can goo through it now.")
            bear_moved = True
            ...
            print("Igo nho idea what that means.")
